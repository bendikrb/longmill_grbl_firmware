...
#ifdef DEFAULTS_LONGMILL
  // Grbl generic default settings. Should work across different machines.
  #define DEFAULT_X_STEPS_PER_MM 200.0
  #define DEFAULT_Y_STEPS_PER_MM 200.0
  #define DEFAULT_Z_STEPS_PER_MM 200.0
  #define DEFAULT_X_MAX_RATE 4000.0 // mm/min updated Dec 17, 2019 from 5000.0
  #define DEFAULT_Y_MAX_RATE 4000.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 3000.0 // mm/min
  #define DEFAULT_X_ACCELERATION (750.0*60*60) // 750*60*60 mm/min^2 = 750 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (750.0*60*60) // 750*60*60 mm/min^2 = 750 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (500.0*60*60) // 500*60*60 mm/min^2 = 500 mm/sec^2
  #define DEFAULT_X_MAX_TRAVEL 812.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 812.0 // mm NOTE: Must be a positive value.
